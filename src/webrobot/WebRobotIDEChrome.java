...
public class WebRobotIDEChrome {
	
	 public static void main(String[] args) throws InterruptedException {
	
		Map<String, Object> vars;
		JavascriptExecutor js, jsChrome, jsEdge;
		for(int i=0;i<2000;i++) {
			...
			try {
				...
				driverChrome.get("https://padlet.com/educaciontrendi/yxbdm3vsnd8t7xnq");
				driverEdge.get("https://padlet.com/educaciontrendi/yxbdm3vsnd8t7xnq");
				...
				driverChrome.findElement(By.xpath("//div[@id=\'wish-2309587956\']/div/article/div/section/div/div/div/i")).click();
				driverEdge.findElement(By.xpath("//div[@id=\'wish-2309587956\']/div/article/div/section/div/div/div/i")).click();
				...
				driverChrome.findElement(By.cssSelector(".oricon:nth-child(5)")).click();
				driverEdge.findElement(By.cssSelector(".oricon:nth-child(5)")).click();
